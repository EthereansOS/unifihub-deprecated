                ...
                <section className="grimoireBoxAll">
                    <section className="grimoireBox">
                        ...
                        <article className="grimoireArticle" id="Craftbasics">
                            ...
                            <p>UniFi Crafting resolves this by offering programmable liquidity, but with Uniswap as base DeFi layer, taking advantage of its secure and decentralized core. This also helps liquidity providers customize their investments, and empowers new applications on top of Uniswap.</p>
