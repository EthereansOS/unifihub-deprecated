                ...
                <section className="grimoireBoxAll">
                    <section className="grimoireBox">
                        <ul className="grimoireIndex">
                            ...
                            <a href="#UnifiERN"><b>UniFi Earning System</b></a>
                        </ul>
                        <article className="grimoireArticle" id="Unifibasics">
                            <h2>Basics</h2>
                            <p>UniFi is a new Decentralized Flexible Organization (DFO) that researches and develops a responsible Decentralized Finance layer on top of Uniswap. Thanks to the DFOhub standard, UniFi dApps are entirely independent from any off-chain entity. The $UniFi voting token is a programmable equity of the UniFi DFO; $UniFi holders hold real equity of the protocol, and rule every part of its code and assets. More info here: <a target="_blank" href="https://dfohub.com"> dfohub.com</a></p>
                        </article>
                        ...
                        <article className="grimoireArticle" id="UnifiLS">
                            ...
                            <p>Staking will inflate the supply over the first year (if every tier is completely filled) by 918,000 $UniFi (1% of the supply).</p>
