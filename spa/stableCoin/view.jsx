            ...
            return (<section className="StableCoinTitle StableCoinTitleALWAYS">
                <section className="StableCoinTitleIntern">
                    ...
                    <article>
                        ...
                        <h6><b>It’s time to farm stablecoins by stabilizing {window.stableCoin.symbol}!</b><br />You can see this section if {window.stableCoin.symbol} price is  greater or less to $1.<br></br><b>What {window.stableCoin.symbol} Arbitrage Farming is about?</b><br></br><br></br> If {window.stableCoin.symbol} is grater than $1, you can stabilize it and earn in a single transaction by 1- Minting uSD, by adding to a stablecoin tier; 2- Swapping your minted uSD for another stablecoin; And earning extra stablecoins from the difference. <br></br><br></br>If {window.stableCoin.symbol} is less than $1, you can stabilize it and earn in a single transaction by 1- Swapping a stablecoin for uSD; 2- Burning the excess uSD for another stablecoin; And 3- ultimately ending up with same $ amount you started with plus extra stablecoins <b></b><a href={window.getNetworkElement("etherscanURL") + "token/" + window.stableFarming.options.address} target="_blank">Contract</a> <a href="https://b-u-i-d-l.github.io/unifi-docs/stableCoin/farming/IUnifiedStableFarming/" target="_blank">Documentation</a></h6>
                    </article>
                </section>
            </section>);
        }
